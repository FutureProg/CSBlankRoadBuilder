...
{
	[ModOptions(MARKINGS, "Automatic Markings", "Changes what kind of markings are generated with the road")]
	public static MarkingsSource MarkingsGenerated { get => (MarkingsSource)_markings.value; set => _markings.value = (int)value; }

	[ModOptions(MARKINGS, "Global Markings Style", "Changes the style of lane markings used when generating a road")]
	public static MarkingStyle MarkingsStyle { get => (MarkingStyle)_markingsStyle.value; set => _markingsStyle.value = (int)value; }

	[ModOptions(MARKINGS, "Vanilla crosswalks style", "Changes how the vanilla crosswalks are generated")]
	...
	[ModOptions(MARKINGS, "Place traffic lights on the opposite side of the junction", "Traffic lights' positions will be at the start of the lanes instead of at the end")]
	public static bool FlipTrafficLights { get => _flipTrafficLights; set => _flipTrafficLights.value = value; }

	[ModOptions(MARKINGS, "Add lane arrows", "Generates lane arrow decals with the road")]
	public static bool AddLaneArrows { get => _addLaneArrows; set => _addLaneArrows.value = value; }

	[ModOptions(MARKINGS, "Add lane decals", "Generates lane decals like bus & bike decals with the road")]
	public static bool AddLaneDecals { get => _addLaneDecals; set => _addLaneDecals.value = value; }

	[ModOptions(MARKINGS, "Add grass props to grass lanes", "Enabling this adds repeating grass props to any lane with grass decorations on top of the generated filler")]
	public static bool AddGrassPropsToGrassLanes { get => _addGrassPropsToGrassLanes; set => _addGrassPropsToGrassLanes.value = value; }

	[ModOptions(MARKINGS, "Remove curb on Flat Roads", "Removes the curb texture on the edge of the asphalt of flat roads")]
	public static bool RemoveCurbOnFlatRoads { get => _flatRoadsHaveNoCurb; set => _flatRoadsHaveNoCurb.value = value; }

	[ModOptions(MARKINGS, "Always add ghost lanes for pedestrian and curb lanes", "Disabling this removes the extra ghost lanes added when you're not using IMT markings")]
	public static bool AlwaysAddGhostLanes { get => _alwaysAddGhostLanes; set => _alwaysAddGhostLanes.value = value; }

	[ModOptions(MARKINGS, "Hide road clutter by default", "Road clutter includes signs, parking meters, etc. They can still be shown using their AN toggle")]
	public static bool HideRoadClutter { get => _hideRoadClutter; set => _hideRoadClutter.value = value; }

	[ModOptions(MARKINGS, "Default Tram tracks", "Changes the default style of tracks used for Trams, other options will remain available with AN toggles")]
	public static TramTracks TramTracks { get => (TramTracks)_tramTracks.value; set => _tramTracks.value = (int)value; }

	[ModOptions(MARKINGS, "Elevated step slope", "Changes the steepness of elevated step transitions at intersections")]
	public static StepSteepness StepTransition { get => (StepSteepness)_stepTransition.value; set => _stepTransition.value = (int)value; }

	[ModOptions(MARKINGS, "Streetlight repeat distance", "Changes the distance between each street light", 6, 64, 0.5F, "m")]
	public static float LightRepeatDistance { get => _lightRepeatDistance.value; set => _lightRepeatDistance.value = value; }

	[ModOptions(MARKINGS, "Use vanilla streetlight placement", "Generates the lights with a standard repeat distance")]
	...
	[ModOptions(MARKINGS, "Randomize tree distances")]
	public static bool RandomizeTreeDistance { get => _randomiseTreeDistance; set => _randomiseTreeDistance.value = value; }

	[ModOptions(MARKINGS, "Use vanilla tree placement", "Generates the trees with a standard repeat distance")]
	public static bool VanillaTreePlacement { get => _vanillaTreePlacement; set => _vanillaTreePlacement.value = value; }

	[ModOptions(MARKINGS, "Only add trees to ground elevation", "Only adds the trees on the ground elevation")]
	public static bool GroundOnlyTrees { get => _groundOnlyTrees; set => _groundOnlyTrees.value = value; }

	[ModOptions(MARKINGS, "Disable the auto-fill of information and thumbnails in the save panel")]
